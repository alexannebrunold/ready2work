    ...
    <section className='page_connexion'>
      <div className='information_content mt-2'>
        <div className='titre_intro_connexion'>
          ...
          <p>
            Rentrez vos identifiants pour avoir accès à l’emploi du temps de vos salles
            en temps réel!
          </p>
        </div>
        <form method='POST' className='connexion_form mt-2'
          onSubmit={e => submitForm(e)} id='form_connexion'>
          <InputForm
            required={true}
